<template>
  <header class="header">
    <RouterLink to="/" active-class="active" style="display: inline-flex; align-items: center;">
...
export default {
  ...
  mounted() {
    // calling the toggle display for the first time
    this.toggle_display()
  },
  methods: {
    // this method toggles the navbar view
    toggle_display() {
